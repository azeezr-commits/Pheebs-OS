      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '13px', color: '#666666', margin: '4px 0 0 0' }}>
            {brief.category} • ⭐ {brief.rating} ({brief.reviewCount} reviews)
          </p>
        </div>
        <button
          onClick={onReset}
      ...
      <div style={{ marginBottom: '36px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
          {brief.evidenceFacts.map((fact, idx) => (
            <div key={idx} style={{ background: '#FFFFFF', border: '1px solid #EAE8E3', padding: '12px 16px', borderRadius: '8px', fontSize: '13.5px', color: '#1A1A1A', display: 'flex', alignItems: 'center', gap: '10px' }}>
      ...
      <div style={{ marginBottom: '36px' }}>
        ...
        <div style={{ background: '#FFFFFF', border: '1px solid #EAE8E3', borderRadius: '10px', padding: '20px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <span style={{ fontSize: '12.5px', color: '#666666' }}>
            Based on {brief.signalCount} public signals
          </span>
        </div>
      </div>
